    ...
    */
    ...
    'channels' => [
        'google_maps' => [
            ...
            'keyword_placeholder' => 'Select from list',
        ...
        'openstreetmap' => [
            ...
            'label' => 'OpenStreetMap',
            'keyword_label' => 'Business type',
            'keyword_placeholder' => 'e.g. cafe, dentist, electronics',
            'requires_location' => true,
        ...
        'yellow_pages' => [
            ...
            'keyword_placeholder' => 'e.g. plumber, dentist, restaurant',
            'requires_location' => true,
            'dedupe_metadata_key' => 'yellow_pages_listing_id',
        ],
        'manta' => [
            'tier' => 'warm',
            'enabled' => true,
            ...
            'keyword_placeholder' => 'e.g. plumber, auto repair',
            'requires_location' => true,
            'dedupe_metadata_key' => 'manta_business_id',
        ],
        'foursquare' => [
            'tier' => 'warm',
            'enabled' => true,
            ...
            'label' => 'Foursquare',
            'keyword_label' => 'Business type',
            'keyword_placeholder' => 'e.g. cafe, gym, salon',
            'requires_location' => true,
            'dedupe_metadata_key' => 'foursquare_place_id',
        ],
        'the_manifest' => [
            'tier' => 'warm',
            'enabled' => true,
            'implemented' => true,
            'label' => 'The Manifest',
            'keyword_label' => 'Agency / service niche',
            'keyword_placeholder' => 'e.g. web design, marketing',
            'requires_location' => true,
            'dedupe_metadata_key' => 'manifest_profile_id',
        ],
        'goodfirms' => [
            'tier' => 'warm',
            'enabled' => true,
            ...
            'label' => 'GoodFirms',
            'keyword_label' => 'Agency / service niche',
            'keyword_placeholder' => 'e.g. web development, SEO',
            'requires_location' => true,
            'dedupe_metadata_key' => 'goodfirms_profile_id',
        ],
        'designrush' => [
            'tier' => 'warm',
            'enabled' => true,
            'implemented' => true,
            'label' => 'DesignRush',
            'keyword_label' => 'Agency category',
            'keyword_placeholder' => 'e.g. web design, branding',
            'requires_location' => true,
            'dedupe_metadata_key' => 'designrush_profile_id',
        ],
        'upcity' => [
            'tier' => 'warm',
            'enabled' => true,
            'implemented' => true,
            'label' => 'UpCity',
            'keyword_label' => 'Service category',
            'keyword_placeholder' => 'e.g. marketing, IT services',
            'requires_location' => true,
            'dedupe_metadata_key' => 'upcity_profile_id',
        ],
        'reddit' => [
            'tier' => 'hot',
            'enabled' => false,
