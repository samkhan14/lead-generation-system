...
class IngestLeadRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'yellow_pages_listing_id' => ['nullable', 'string', 'max:255'],
            'yellow_pages_url' => ['nullable', 'string', 'max:500'],
            'manta_business_id' => ['nullable', 'string', 'max:255'],
            'manta_url' => ['nullable', 'string', 'max:500'],
            'foursquare_place_id' => ['nullable', 'string', 'max:255'],
            'foursquare_url' => ['nullable', 'string', 'max:500'],
            'manifest_profile_id' => ['nullable', 'string', 'max:255'],
            'manifest_url' => ['nullable', 'string', 'max:500'],
            'goodfirms_profile_id' => ['nullable', 'string', 'max:255'],
            'goodfirms_url' => ['nullable', 'string', 'max:500'],
            'designrush_profile_id' => ['nullable', 'string', 'max:255'],
            'designrush_url' => ['nullable', 'string', 'max:500'],
            'upcity_profile_id' => ['nullable', 'string', 'max:255'],
            'upcity_url' => ['nullable', 'string', 'max:500'],
